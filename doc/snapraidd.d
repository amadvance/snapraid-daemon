...
Configuration
  ...
  System
	...
	prefail - Shuts down the host immediately after sending reports if
		array health transitions to prefail. Queued tasks and post-hooks
		are canceled, and paused Docker containers are not unpaused,
		to prevent further disk activity.
	failing - Shuts down the host immediately after sending reports if
		array health transitions to failing. Queued tasks and post-hooks
		are canceled, and paused Docker containers are not unpaused,
		to prevent further disk activity.
