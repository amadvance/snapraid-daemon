...
#define SMART_ENTRY_PREFAIL 1
#define SMART_ENTRY_INFO 2
#define SMART_ENTRY_TEMP 4
#define SMART_ENTRY_PULSE 8
...
struct smart_entry {
	...
	/* critical entries */
	{ 5, 16, "New_Bad_Blk_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 5, 16, "New_Bad_Block_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 5, 16, "Realloc_Flash_Blocks_Ct", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 5, 16, "Reallocated_Sector_Ct", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 5, 16, "Retried_Blk_Ct", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 5, 48, "Later_Bad_Block", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 5, 48, "Reallocate_NAND_Blk_Cnt", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 5, 48, "Reallocated_Block_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 5, 48, "Retired_Block_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 5, 48, "Runtime_Bad_Block", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
//	{ 10, 48, "Not_In_Use", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 10, 48, "Spin_Retry_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 10, 48, "Spin_Retry_Count,HDD", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
//	{ 10, 48, "Unknown_JMF_Attribute", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
//	{ 10, 48, "Unknown_Maxio_Attribute", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 184, 48, "End-to-End_Error", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 184, 48, "End-to-End_Error_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 184, 48, "Error_Correction_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
//	{ 184, 48, "Factory_Bad_Block_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 184, 48, "IO_Error_Detect_Code_Ct", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
//	{ 184, 64, "Initial_Bad_Block_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 187, 48, "Reported_UE_Counts", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 187, 48, "Reported_Uncorr_Errors", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 187, 48, "Reported_Uncorrect", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 187, 48, "Total_Unc_NAND_Reads", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 187, 48, "Uncorrectable_ECC_Ct", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 187, 48, "Uncorrectable_Error_Cnt", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
//	{ 187, 48, "Unknown_JMF_Attribute", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 188, 16, "Command_Timeout", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE }, /* adjusted to 16 */
	{ 188, 16, "Command_Timeouts", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE }, /* adjusted to 16 */
	{ 195, 16, "RAISE_ECC_Cor_Ct", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 195, 24, "ECC_On_the_Fly_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 195, 24, "ECC_On_the_Fly_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 195, 24, "ECC_Uncorr_Error_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
//	{ 195, 24, "Hardware_ECC_Recovered", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
//	{ 195, 48, "Cumulativ_Corrected_ECC", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 195, 48, "ECC_Error_Rate", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 195, 48, "ECC_On_the_Fly_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 195, 48, "ECC_on_the_Fly_Rate", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
...
//	{ 196, 48, "Not_In_Use", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	...
	{ 196, 48, "Total_Erase_Failures", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 196, 48, "Total_Spare_Block_Cnt", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 196, 64, "Erase_Failure_Blk_Ct", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 197, 48, "Current_Pending_ECC_Cnt", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 197, 48, "Current_Pending_Sector", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 197, 48, "ECC_Error_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
//	{ 197, 48, "Not_In_Use", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
	{ 197, 48, "Pending_Sector_Count", SMART_ENTRY_PREFAIL | SMART_ENTRY_PULSE },
...
//	{ 194, 48, "Device_Temperature", SMART_ENTRY_TEMP | SMART_ENTRY_PULSE }, /* not present in https://github.com/linuxhw/SMART and EnterpriseDrive */
	...
	/* other entries */
	{ 4, 48, "Start_Stop_Count", SMART_ENTRY_INFO },
	{ 9, 32, "Power_On_Hours_and_Msec", SMART_ENTRY_INFO }, /* hours are in the lower 32 bit */
	{ 9, 24, "Power_On_Hours", SMART_ENTRY_INFO },
	{ 12, 48, "Power_Cycle_Count", SMART_ENTRY_INFO },
//	{ 193,raw48,Dynamic_Remaps", SMART_ENTRY_INFO },
	{ 193, 48, "Load_Cycle_Count", SMART_ENTRY_INFO },
//	{ 193, 48, "Power_Fail_Uncompl_Cnt", SMART_ENTRY_INFO },
	{ 0 }
};
...
int is_smart_pulse(int index, const char* name)
{
	for (int i = 0; SMART_ENTRIES[i].index; ++i) {
		if (SMART_ENTRIES[i].index == index && strcmp(SMART_ENTRIES[i].name, name) == 0)
			return (SMART_ENTRIES[i].flags & SMART_ENTRY_PULSE) != 0;
	}
	...
	for (int i = 1; i < SMART_COUNT; ++i) {
		...
		if (entry->index != 0) {
			...
			if (value != SMART_UNASSIGNED) {
				...
				if (flags & SMART_ENTRY_PREFAIL)
					ss_json_str(s, level, "type", "prefail");
				else if (flags & SMART_ENTRY_TEMP)
